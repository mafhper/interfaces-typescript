...
function cadastrarLivro(titulo, autor) {
    ...
    const livroExistente = catalogoLivros.find((l) => l.titulo.toLowerCase() === titulo.toLowerCase());
    if (livroExistente) {
...
function emprestarLivro(titulo) {
    const livro = catalogoLivros.find((l) => l.titulo.toLowerCase() === titulo.toLowerCase());
    if (!livro) {
