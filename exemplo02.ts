 ...
 */
function cadastrarLivro(titulo: string, autor: string): void {
 ...
 */
function listarDisponiveis(): void {
 ...
 */
function listarTodosOsLivros(): void {
  ...
  if (catalogoLivros.length === 0) {
    ...
    catalogoLivros.forEach((livro) => {
      console.log(
        `Título: "${livro.titulo}", Autor: ${livro.autor}, Emprestado: ${
